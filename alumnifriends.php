    ...
    <thead class="table-dark">
      <tr>
		...
		if(isset($_POST['filter'])){
		    if(isset($_POST['titleTextbox']) and isset($_POST['sort_order']) and isset($_POST['titleTextbox1'])){
		        $sec=$_POST['sort_order'];
		        $title = $_POST['titleTextbox'];
						$yop = $_POST['titleTextbox1'];
		        $sql = "SELECT * FROM alumnistatus inner join alumni on alumnistatus.id = alumni.id WHERE sector = '$sec' and title = '$title' and enddate = 'PRESENT' and yop = '$yop'";
